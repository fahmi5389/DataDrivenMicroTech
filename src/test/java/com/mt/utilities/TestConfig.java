...
public class TestConfig{
	...
	public static String from = "hillside167jamaica@gmail.com";
	public static String password = "167Hillside";
	public static String[] to ={"imteaz.fahmi@gmail.com","hillside167jamaica@gmail.com"};
